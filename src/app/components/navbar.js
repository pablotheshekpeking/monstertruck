...
const Navbar = () => {
    ...
    return (
        ...
        >
            <Box>
                <Img w={'25%'} h={'auto'} src='https://media.istockphoto.com/id/1252703616/photo/monster-truck.jpg?s=612x612&w=0&k=20&c=k3tT3tVygsZWdU-AemqBCoHGO7GnfUyy98QJIKXtg3Q=' />
            </Box>
            <Box
